...
class Matrix4{   
	public:
		...
		void rotateA(double,Vector4);		//rotate around an arbitrary axis.		
		...
		Matrix4 translation(Vector4);			//creates a translation matrix by making the last column of an identity matrix the vector.
