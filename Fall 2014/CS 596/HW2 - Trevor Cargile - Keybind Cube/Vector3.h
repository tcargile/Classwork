...
public:
	...
	void subtractV(Vector3, int);			//subtract the Vector3 from the existing one, int is used to say which vector is being subtracted from what.
	void crossV(Vector3, int);				//perform cross product with the specified vector, int used to specify order.
