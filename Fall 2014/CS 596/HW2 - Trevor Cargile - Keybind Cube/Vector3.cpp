...
void Vector3::subtractV(Vector3 vector, int direction){
	if (direction == 0){
		c[0] -= vector.c[0];
		c[1] -= vector.c[1];
		c[2] -= vector.c[2];
...
void Vector3::crossV(Vector3 vector, int direction){
	if (direction == 0){
		c[0] = c[1] * vector.c[2] - vector.c[1] * c[2];
		c[1] = -(c[0] * vector.c[2] - vector.c[0] * c[2]);
		c[2] = c[0] * vector.c[1] - vector.c[0] * c[1];
	}
	else{
		c[0] = -(c[1] * vector.c[2] - vector.c[1] * c[2]);
		c[1] = c[0] * vector.c[2] - vector.c[0] * c[2];
